...
public class HistoryBetweenDateAndNowLocFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_history_between_date_loc, container, false);
        ...
        calendarView = view.findViewById(R.id.calendarBetweenDateAndNow);
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewHistoryBetweenDateAndNowLoc);
    ...
    public void getLocations(final LocationAPI.LocationListCallback callback) {
        locationAPI.getLocationsSinceDate(getContext(), email, token, selectedDate, new LocationAPI.LocationListCallback() {
            @Override
            public void onSuccess(List<Location> locationList) {
